...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $Code = random_int(1, 9) . random_int(0, 9) . random_int(0, 9);


    $SQLStr = 'INSERT INTO employee (Name, Surname, Email, Password, Code) VALUES (?,?,?,?,?)';
    $StmtObj = $DbConnectionObj->prepare($SQLStr);
    $StmtObj->bind_param('ssssi', $FirstNameStr, $SurnameStr, $EmailAddressStr, $HashedPassword, $Code);
    try {
        $StmtObj->execute();
